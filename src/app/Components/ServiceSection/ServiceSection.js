...
const ServiceSection = forwardRef(
  ({ title, icon, description, features, imageSrc }, ref) => (
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="flex items-center">
              <div className="bg-gray-200 rounded-full p-3 mr-3 text-blue-600">
                {feature.icon}
              </div>
...
// Adding a display name to the ServiceSection component
