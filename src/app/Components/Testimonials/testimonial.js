      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="lg:w-2/3">
          <blockquote className="p-6">
            <h3 className="font-bold text-center text-2xl mb-3">{testimonials[activeIndex].short}</h3> 
            <p className="sm:text-xl text-base text-center italic mb-4 font-light">&quot;{testimonials[activeIndex].testimonial}&quot;</p>
          </blockquote>
        </div>
      </div>
    // </div>
