...
export default function Reviews() {
  ...
  return (
    <div className="reviews-container">
      ...
      `}</style>
      <div>
      <div className="services-heading flex flex-col md:flex-row justify-between p-4 lg:mx-36  mt-12">
          <div className="left text-center md:text-left">
            ...
            CL<span className="bg-gradient-to-r from-pink-600 via-blue-500 to-green-400 inline-block text-transparent bg-clip-text">I</span>EN<span className="bg-gradient-to-r from-pink-600 via-blue-500 to-green-400 inline-block text-transparent bg-clip-text">T</span>S
            </h1>
          </div>
